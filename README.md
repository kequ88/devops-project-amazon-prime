...
1. **Clone the Repository** (Open Command Prompt & run below):
   ```bash
   git clone https://github.com/kequ88/devops-project-amazon-prime.git
   cd devops_project_amazon_prime
...
pipeline {
    ...
    stages {
        stage('1. Git Checkout') {
            steps {
                git branch: 'main', url: 'https://github.com/kequ88/devops-project-amazon-prime.git'
            }
        }
        ...
        stage('Cleanup K8s Resources') {
            steps {
                script {
                    ...
                    sh 'kubectl delete deploy kequcloud-app || true'
                    sh 'kubectl delete svc kequcloud-app || true'
